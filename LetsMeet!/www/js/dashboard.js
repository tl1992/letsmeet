...
document.addEventListener("deviceready", onDeviceReady, false);
	...
	function onDeviceReady() {
		...
		$("#inviteForm").on("submit",function(e) {
			...
			var u = $("#inviteName", this).val();
			var p = $("#invitePhone", this).val();
			//if(u != '' && p!= '') {
				$.post("http://dannycoenen.nl/app/letsmeet/register.php?", {name:u,phone:p}, function(res) {
					if(res == true) {
						navigator.notification.alert("Uitnodiging opgelsagen", function() {});
					} else {
						navigator.notification.alert("Kan uitnodiging niet opslaan", function() {});
					}
